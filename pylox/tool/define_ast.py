...
def define_ast(output_dir, basename, types):
    with open(output_dir, "w") as f:
        f.write("# Auto-generated by tool/define_ast.py\n")
        ...
        for expr in types:
            ...
            f.write(f"class {class_name}(Expr):\n")
...
def define_visitor(output_dir, types):
    with open(output_dir, "w") as f:
        f.write("# Auto-generated by tool/define_ast.py\n")
        f.write("from abc import ABC, abstractmethod\n")
        joined_types = ", ".join([type.split("|")[0].strip() for type in types])
        f.write(f"from .expr import {joined_types}\n")
        f.write("\n")
